...
### New Features
- Add support for inverted mapping, that can be used to map internal structure to external representation (e.g., for errors). ([#](https://github.com/CiTroNaK/verquest/pull/), [@CiTroNaK](https://github.com/CiTroNaK))
