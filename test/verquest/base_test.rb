...
module Verquest
  class BaseTest < Minitest::Test
    ...
    def test_map_with_invalid_params_with_result_object
      ...
      expected_errors = [
        "The property '#/' did not contain a required property of 'field_root_string_mapped' in schema #/components/schemas/CompleteExampleRequest",
        "The property '#/' did not contain a required property of 'field_root_number_mapped_nested' in schema #/components/schemas/CompleteExampleRequest",
        "The property '#/' did not contain a required property of 'field_root_boolean_unmapped' in schema #/components/schemas/CompleteExampleRequest",
        "The property '#/' did not contain a required property of 'field_root_integer_unmapped' in schema #/components/schemas/CompleteExampleRequest",
        "The property '#/' contains additional properties [\"param\"] outside of the schema when none are allowed in schema #/components/schemas/CompleteExampleRequest"
      ]
